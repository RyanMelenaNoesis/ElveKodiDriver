...
{
	[Driver("Kodi Driver", "A driver for monitoring and controlling Kodi media player.", "Ryan Melena", "Media Player", "", "Kodi", DriverCommunicationPort.Network, DriverMultipleInstances.MultiplePerDriverService, 0, 1, DriverReleaseStages.Production, "Kodi", "https://kodi.tv/", null)]
