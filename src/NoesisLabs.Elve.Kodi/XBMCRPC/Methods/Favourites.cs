        ...
        private readonly Client _client;
          public Favourites(Client client)
          {
              _client = client;
                ...
                /// </summary>
        public string AddFavourite(string title=null, XBMCRPC.Favourite.Type type=0, string path=null, string window=null, string windowparameter=null, string thumbnail=null)
        {
            ...
            return _client.GetData<string>("Favourites.AddFavourite", jArgs);
        }

                /// <summary>
                /// Retrieve all favourites
                /// </summary>
        public XBMCRPC.Favourites.GetFavouritesResponse GetFavourites(XBMCRPC.Favourite.Type type=0, XBMCRPC.Favourite.Fields.Favourite properties=null)
        {
            var jArgs = new JObject();
             if (type != null)
             {
            ...
            return _client.GetData<XBMCRPC.Favourites.GetFavouritesResponse>("Favourites.GetFavourites", jArgs);
        }
   }
}
