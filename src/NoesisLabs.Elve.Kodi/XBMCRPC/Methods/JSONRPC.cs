...
namespace XBMCRPC.Methods
{
   public partial class JSONRPC
   {
        private readonly Client _client;
          public JSONRPC(Client client)
          {
              _client = client;
                ...
                /// </summary>
        public XBMCRPC.JSONRPC.IntrospectResponse Introspect(bool getdescriptions=false, bool getmetadata=false, bool filterbytransport=false, XBMCRPC.JSONRPC.Introspect_filter filter=null)
        {
            ...
            return _client.GetData<XBMCRPC.JSONRPC.IntrospectResponse>("JSONRPC.Introspect", jArgs);
        }

                /// <summary>
                /// Notify all other connected clients
                /// </summary>
        public object NotifyAll(string sender=null, string message=null, object data=null)
        {
            var jArgs = new JObject();
             if (sender != null)
             {
            ...
            return _client.GetData<object>("JSONRPC.NotifyAll", jArgs);
        }

                /// <summary>
                /// Retrieve the clients permissions
                /// </summary>
        public XBMCRPC.JSONRPC.PermissionResponse Permission()
        {
            var jArgs = new JObject();
            return _client.GetData<XBMCRPC.JSONRPC.PermissionResponse>("JSONRPC.Permission", jArgs);
        }
        ...
        {
            var jArgs = new JObject();
            return _client.GetData<string>("JSONRPC.Ping", jArgs);
        }

                /// <summary>
                /// Retrieve the JSON-RPC protocol version.
                /// </summary>
        public XBMCRPC.JSONRPC.VersionResponse Version()
        {
            var jArgs = new JObject();
            return _client.GetData<XBMCRPC.JSONRPC.VersionResponse>("JSONRPC.Version", jArgs);
        }
   }
}
