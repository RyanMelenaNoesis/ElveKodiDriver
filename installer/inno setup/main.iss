...
AppId={{97B66967-E483-4220-9803-147173A3ACBA}
AppName={#MyAppName}
...
OutputBaseFilename=Elve Kodi Driver 0.1
Compression=lzma
...
[Files]
Source: "..\..\src\NoesisLabs.Elve.Kodi\bin\Release\NoesisLabs.Elve.Kodi.dll"; DestDir: "{%PROGRAMDATA}\Codecore Technologies\Elve\DeviceDrivers\Compiled"; Flags: ignoreversion
...
begin
      SimpleStopService('ElveDriverService', True, True);
      SimpleStopService('ElveMasterService', True, True);
end;

procedure CurStepChanged(CurStep: TSetupStep);
begin
  if CurStep = ssPostInstall then begin
      SimpleStartService('ElveDriverService', True, True);
      SimpleStartService('ElveMasterService', True, True);
  end;
end;
